...
export default function LandingPage() {
  ...
  useEffect(() => {}, [isLeftMenuOpen]);

  return (
    <div className='grid-cols-homepage-grid-cols grid-rows-homepage-grid-rows min-h-screen grid h-'>
      <TopMenu
      ...
      <ContentWrapper isLeftMenuOpen={isLeftMenuOpen}>
        <div className='pb-4 border-b border-gray-300'>
          <h3 className='font-inter text-xl font-bold'>Sample Title</h3>
          <h3 className='font-inter text-base'>
            Some sub head texts goes here
          </h3>
        </div>
        ...
        <div className='pb-4 border-b border-gray-300'>
          <h3 className='font-playfair text-2xl font-bold'>Sample Title</h3>
          <h3 className='font-inter text-base'>
            Some sub head texts goes here
          </h3>
        </div>
